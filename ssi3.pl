...
%%writeln1([i11]),pred_id
	...
	*/
	...
	%retractall(curr_cp_index(_)),
 	%assertz(curr_cp_index(0)),
...
(delete_cp(Choice_point_trail1,[_,_,Pred_id,Level,_Predicate_number2,Line_number2b,Pred_or_line,_Query2,Vars4,All_predicate_numbers2],Choice_point_trail12,CP_Vars1,CP_Varsx),
...
delete_until_last_cp(Choice_point_trail11,Choice_point_trail6,D1,AC,CP_Vars1,CP_Vars2),
...
%****
	...
	/*
ssi1([-,Level,Predicate_number,["returns to",P_num],"predicate",Query_a,
	Vars,All_predicate_numbers], Result21, Functions,Vars2,
	Result1, Result2, 
	Globals1,Globals2,
	Choice_point_trail1,
...
ssi1([-,Level,P_num,-1,"predicate",Query_a,
	Vars,All_predicate_numbers], Result21, Functions,Vars2,
	Result1, Result2, 
	Globals1,Globals2,
	Choice_point_trail1,
...
ssi1([-,Level,Predicate_number,Line_number,"predicate",Query_a,
	...
	%([-,Level,Predicate_number,Line_number]=[-,7,17,-1]->trace;true),
%trace,
%(Query='-'->trace;true),
%/*
	(debug2(on)->
...
debug_call(Skip1,[Function,Arguments1]),
	...
	(false%a(1) 
	% unused
	-> append_cp(Choice_point_trail1,[[Level,Predicate_number,-1,"predicate",Query,
	Vars3,
...
%	_Vars,_All_predicate_numbers],Choice_point_trail5)),
	...
	get_last_cp_before_n(Choice_point_trail1,[%_,_,
	Pred_id4,Level,_Predicate_number4,-1,"predicate",[Function,Arguments1], %**
	_Vars,_All_predicate_numbers4],
	[_,_,Pred_id4,Level,_Predicate_number4,-1,"predicate",[Function,Arguments1], %**
...
%not_last_line()
		/*((Level=0 ->
		(				
	(delete_until_last_cp(Choice_point_trail5,Choice_point_trail6,D1)->
...
ssi1([-,0,_Predicate_number,-2,"predicate",_Query_a,
	...
	%(
		...
		%trace,
		%writeln1([choice_point_trail1,Choice_point_trail1]),
		%writeln(here3),

		get_last_cp_before_n(Choice_point_trail1,
	[Pred_id2,Level2,Predicate_number2,Line_number2b,"predicate",_Query2,Vars4,All_predicate_numbers2],
	[_Cp_a,_Cb_b,Pred_id2,Level2,Predicate_number2,Line_number2b,"predicate",_Query2,Vars4,All_predicate_numbers2],_,
	CP_Vars3,CP_Vars4),
...
/*
	...
	*/
	e(_Pred_id,Level,Vars3,_End_result,Functions,Vars2,Result1, Result2, 
	Globals1,Globals2,
	Choice_point_trail1,
	Choice_point_trail3,
	CP_Vars1,CP_Vars2
...
cp_since_findall_start(Choice_point_trail1e,Level,D1,E1,CP_Vars3,CP_Vars31)
 ...
 interpretpart(match4,Format_vars,[Dbw_v,Sys_name],Vars1,Vars2fa,_),
	...
	get_last_cp_before_n(Choice_point_trail1e,D1,[Cp_a1,Cp_a2|D1],_,CP_Vars31,CP_Vars4),
...
append_cp(Choice_point_trail1c,[[Pred_id2,Level3,CPV1,Line_number_a2,Pred_or_line,_,_,CPV22]],Choice_point_trail1d,CP_Vars7,CP_Vars8),
	...
	get_last_cp_before_n(Choice_point_trail4,[_,_Level,_Predicate_number,_Line_number_a,"findall",-,[old_vars,Old_vars],[findall_vars,Findall_vars],[format_vars,Format_vars],[result_var,Result_var]],
...
find_sys(Sys_name),
	...
	delete_cp(Choice_point_trail1e,D1,Choice_point_trail1a,CP_Vars4,CP_Vars5), %%*** Choice_point_trail1 to Choice_point_trail1e
...
(d(Pred_id,D,Level,Predicate_number,Line_number_b,Query,Vars1,Vars2,All_predicate_numbers,Line,Choice_point_trail1,Globals3,Functions,Result1, Result2,Globals2,Choice_point_trail3,CP_Vars3,CP_Vars2));
	((%trace,
	(AC=(-) ->
...
%vars2e=[[[n,member2],[[1,2,3],empty],[[1,2,3],1]],[[[v,a],[1,2,3*1?]],[[v,b],3]],[[[[[v,a],[1,2,3]],[[v,b],2]],[[1,2,3],2]],[[[[v,a],[1,2,3]],[[v,b],3]],[[1,2,3],3]]]]
	...
	%subtract(C1,D2,C2),
	delete_cp(Choice_point_trail1,D2,Choice_point_trail3,CP_Vars3,CP_Vars4),
...
%trace,
	...
	[_Pred_id,Level,_Predicate_number,_Line_number_a,"findall",-|_],
	D1,B),
...
append_cp(List1,CP,List5a,CP_Vars1,CP_Vars2) :-
	...
	writeln([append_cp,curr_cp,Curr_cp,Curr_cp1,List5a,CP_Vars1,CP_Vars2]).
	%notrace.
...
%curr_cp_index2=curr_cp_index3
	...
	set(min_cp,Curr_cp_index2,CP_Vars4,CP_Vars5)
	)->true;
	...
	renumber_cps(List5,List5a,CP_Vars2,CP_Vars2a),
	%sort(List5,List5a),

	!.

renumber_cps(List1,List2,CP_Vars1,CP_Vars2) :-
	get(min_cp,Min_cp,CP_Vars1),
	get(max_cp,Max_cp,CP_Vars1),
	get(curr_cp,Curr_cp31,CP_Vars1),
renumber_cps1(List1,Min_cp,Max_cp,[],List2,1,Max_cp2,Curr_cp31,Curr_cp3),
...
renumber_cps1([[A,B|C]],A,B,List1,List2,Curr_cp,Curr_cp2,Curr_cp31,Curr_cp3) :-
...
renumber_cps1(List1,Min_cp,Max_cp,List1a,List2,Curr_cp,Max_cp2,Curr_cp31,Curr_cp3) :-
	...
	(B=Curr_cp31-> Curr_cp3=Curr_cp2;true),	renumber_cps1(List3,B,Max_cp,List4,List2,
		Curr_cp2,Max_cp2,Curr_cp31,Curr_cp3),!.
...
get_last_cp_before_n(List1,Cp1,Cp2,Cp3,CP_Vars1,CP_Vars1) :-
	...
	get(curr_cp,Curr_cp,CP_Vars1),%writeln([curr_cp,Curr_cp]),
	writeln1(get_last_cp_before_n2(List1,Cp1,Cp2,Cp3,CP_Vars1,CP_Vars1)),
	(get_last_cp_before_n2(List1,Cp1,Cp2,Cp3,CP_Vars1,CP_Vars1)->true;(writeln([get_last_cp_before_n2,abort]),abort)),
	%writeln1(get_last_cp_before_n2(List1,Cp1,Cp2,Cp3)),
	get(curr_cp,Curr_cp1,CP_Vars1),%writeln([curr_cp,Curr_cp1]),
	writeln([get_last_cp_before_n,curr_cp,Curr_cp,Curr_cp1,Cp2,CP_Vars1,CP_Vars1]).
	%notrace.
...
get_last_cp_before_n1(List1,Cp1,N,Cp2) :-
	...
	%fail%get_last_cp_before_n1(List1,Cp1,B,Cp2)
	%;
	Cp2=[N,B|Cp1],!.
get_last_cp_before_n1(List1,Cp1,N,Cp2) :-
...
get_earlier_cps_before_cp(List1,Cp1,Cps) :-
	%curr_cp(N),
	Cp1=[_Cp_b,Cp_a|_Cp],
	get_earlier_cps_before_cp(List1,Cp_a,[],Cps1),
	sort(Cps1,Cps).
	%Cp2=[_,_|Cp3].
...
delete_cp(List1,CP,List5,CP_Vars1,CP_Vars2) :-
	%writeln1(delete_cp1(List1,CP,List5)),
	%trace,
	get(curr_cp,Curr_cp,CP_Vars1),%writeln([curr_cp,Curr_cp]),	
	(delete_cp1(List1,CP,List5,CP_Vars1,CP_Vars2)->true;(writeln([delete_cp1,abort]),abort)),
	%writeln1(delete_cp1(List1,CP,List5)),
	get(curr_cp,Curr_cp1,CP_Vars1),%writeln([curr_cp,Curr_cp1]),
	writeln([delete_cp,curr_cp,Curr_cp,Curr_cp1,List5,CP_Vars1,CP_Vars2]).
	%notrace.
	
delete_cp1(List1,CP,List5a,CP_Vars1,CP_Vars2a) :-
	CP=[A,B|CP2],

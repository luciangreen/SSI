...
write(["L",Level]);true),
	...
	e(_Pred_id,Level,_Vars3,_End_result,Functions,Vars2,Result1, Result2, 
	Globals1,Globals2,
	Choice_point_trail1,
	Choice_point_trail3,
	CP_Vars1,CP_Vars2
...
%trace,
	...
	%trace,
	(%trace,
	append_cp(Choice_point_trail1a,[[Pred_id,Level,Predicate_number,[findall_exit_function,Findall_end_line],"predicate",Query,

...
lucianpl1(Debug) :- 
   ...
   assertz(leash1(off)), %% Should normally be off
	...
	retractall(pred_id(_)),
 	...
 	assertz(debug3(on)), % on - displays level
...
ssi1([_,0,_Predicate_number,Line_number,"predicate",_Query_a,
	...
	%/*
	(debug2(on)->
	writeln1(ssi1([_,0,_Predicate_number,Line_number,"predicate",Query_a,
	Vars,_All_predicate_numbers], End_result, Functions,Vars2,
	Result1, Result2, 
	Globals222,Globals2,
	Choice_point_trail1,
...
find_sys(Sys_name),
	...
	delete_cp(Choice_point_trail1e,D1,Choice_point_trail1a,CP_Vars4,CP_Vars5), 
	...
	ssi1([Prev_pred_id,Level, 
	Predicate_number11,-2,"predicate",_Query,
	...
	ssi1([Prev_pred_id,Level,Predicate_number11,Findall_end_line,"line",Query,
...
get_last_cp_before_n(List1,Cp1,Cp2,Cp3,CP_Vars1,CP_Vars1) :-
	...
	(debug4(on)->writeln([get_last_cp_before_n,curr_cp,Curr_cp,Curr_cp1,Cp2,CP_Vars1,CP_Vars1]);true).
	%notrace.
...
delete_cp(List1,CP,List5,CP_Vars1,CP_Vars2) :-
	...
	get(curr_cp,Curr_cp,CP_Vars1),%writeln([curr_cp,Curr_cp]),	
		%trace,
		(debug4(on)->writeln([delete_cp,curr_cp,Curr_cp,CP,List1,List5,CP_Vars1,CP_Vars2]);true),

(delete_cp1(List1,CP,List5,CP_Vars1,CP_Vars2)->true;(writeln([delete_cp1,abort]),abort)),
	%writeln1(delete_cp1(List1,CP,List5)),
	get(curr_cp,Curr_cp1,CP_Vars1),%writeln([curr_cp,Curr_cp1]),
	(debug4(on)->writeln([delete_cp,curr_cp,Curr_cp,Curr_cp1,CP,List1,List5,CP_Vars1,CP_Vars2]);true).
	%notrace.

...
%NTotal=105, 
	!.
ssi_test_all_bt0(test,Arity,Lang,Debug,NTotal1,NTotal2,Score1,Score2,NTotal4) :-
...
ssi_test_all_bt000(test,Debug,NTotal3,Score1,Score3,Lang) :-
	...
	;(writeln("not(Query=Query1)"),abort)),
...
(international_lucianpl([lang,"en"],Debug,Query1,Types1,Modes1,Functions1,Result1)->(Score3 is Score1+1,writeln([ssi_test_types,NTotal3,passed]));(Score3=Score1,writeln([ssi_test_types,NTotal3,failed]))).
...
ssi_test_all_bt000(testopen_cases,Debug,NTotal3,Score1,Score3,Lang) :-
	...
	trans_alg1(Functions,"en",Lang,Functions1),
	(Debug=on->writeln1(Functions1);true),
	((international_lucianpl([lang,"en"],Debug,Query1,Functions1,Result),not(Result=[]))->(Score3 is Score1+1,writeln([ssi_testopen,NTotal3,result,Result]),writeln([ssi_test,NTotal3,passed]));(Score3=Score1,writeln([ssi_testopen,NTotal3,failed]))).
...
((international_lucianpl([lang,"en"],Debug,Query1,Types1,Modes1,Functions1,Result),not(Result=[]))->(Score3 is Score1+1,writeln([ssi_test_open_types,NTotal3,result,Result]),writeln([ssi_test_open_types,NTotal3,passed]));(Score3=Score1,writeln([ssi_test_open_types,NTotal3,failed]))).

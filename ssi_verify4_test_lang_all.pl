...
ssi_test_all000(test,Debug,NTotal3,Score1,Score3,Lang) :-
	...
	trans_alg(Result,"en",Lang,Result1),
			...
			((
catch(call_with_time_limit(10,international_lucianpl([lang,Lang],Debug,Query1,Functions1,Result1)),_,false)	%,writeln1(Result2)
	)
...
(catch(call_with_time_limit(10,international_lucianpl([lang,Lang],Debug,Query1,Types1,Modes1,Functions1,Result1)),_,false)	%,writeln1(Result2)

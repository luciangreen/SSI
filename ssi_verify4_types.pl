...
ssi_test_types(Debug,NTotal1,NTotal2,Score1,Score2) :-
	...
	(international_lucianpl([lang,"en"],Debug,Query,Types,Modes,Functions,Result)->(Score3 is Score1+1,writeln([ssi_test_types,NTotal3,passed]));(Score3=Score1,writeln([ssi_test_types,NTotal3,failed]))),
	writeln(""),
...
ssi_test_types1(Debug,N,Passed) :-
	...
	Result=Result1
	)->(Passed=passed,writeln([ssi_test_types,N,passed]));(Passed=failed,writeln([ssi_test_types,N,failed]))),!.
